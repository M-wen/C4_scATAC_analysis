...
path=get_args()
if os.path.exists(path+'/report/Table2.celltypecount.csv'): 
#    df1= pd.read_csv(open(path+'/report/Table1.dapeak.csv'),encoding="utf-8",dtype=str,)
#    df1 = df1.dropna()
...
#            )
#
    df1 = pd.read_csv(open(path+'/report/Table2.celltypecount.csv'),encoding="utf-8",dtype=str)
